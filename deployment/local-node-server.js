  ...
  sendHtml(res, page(req, null, 'Welcome', `
    ...
    <section class="landing-features">
      ...
      <div class="landing-feature-grid">
        <article class="landing-feature-card"><div class="landing-feature-icon-box"><span class="pixel-nav-icon nav-icon-coin" aria-hidden="true"></span></div><h3>Track Income and Expenses</h3><p>Log money in and out, categorize records, and understand where your pesos go.</p></article>
        <article class="landing-feature-card"><div class="landing-feature-icon-box"><span class="pixel-nav-icon nav-icon-piggy" aria-hidden="true"></span></div><h3>Manage Savings Cart</h3><p>Plan items you want to buy, set target months, and mark items as already bought.</p></article>
        <article class="landing-feature-card"><div class="landing-feature-icon-box"><span class="pixel-nav-icon nav-icon-wallet" aria-hidden="true"></span></div><h3>Monitor Budgets</h3><p>Set monthly category limits and see progress before spending gets out of hand.</p></article>
        <article class="landing-feature-card"><div class="landing-feature-icon-box"><span class="pixel-nav-icon nav-icon-trophy" aria-hidden="true"></span></div><h3>Earn Streaks and Badges</h3><p>Build better habits with XP, rewards, quests, and friendly progress signals.</p></article>
        <article class="landing-feature-card"><div class="landing-feature-icon-box"><span class="pixel-nav-icon nav-icon-receipt" aria-hidden="true"></span></div><h3>Review Monthly Receipts</h3><p>Generate receipt-style monthly summaries to see income, expenses, and remaining balance.</p></article>
      </div>
    </section>
  `, 'landing-shell'));
}
...
function gamification(req, res, data, user) {
  ...
  sendHtml(res, page(req, user, 'Game Hub', `
    ...
    <div class="row g-3 mb-4"><div class="col-md-3"><div class="game-stat-tile"><div class="stat-icon coin"><i class="bi bi-stars"></i></div><div><span>XP</span><strong>${xp}</strong></div></div></div><div class="col-md-3"><div class="game-stat-tile"><div class="stat-icon wallet"><i class="bi bi-controller"></i></div><div><span>Level</span><strong>${level}</strong></div></div></div><div class="col-md-3"><div class="game-stat-tile"><div class="stat-icon piggy"><i class="bi bi-award-fill"></i></div><div><span>Badges</span><strong>${earnedBadges}/${badgesData.length}</strong></div></div></div><div class="col-md-3"><div class="game-stat-tile"><div class="stat-icon expense"><i class="bi bi-fire"></i></div><div><span>Streak</span><strong>${streakDays} days</strong></div></div></div></div>
